  ...
  return (
    <div className="flex justify-between items-center px-2 py-2 dark:bg-gray-800 bg-gray-200 rounded-2xl mb-5">
      ...
      <div className="flex gap-5">
        <button className="px-3 py-1 outline outline-amber-400 rounded-xl font-semibold">
          View Details
        </button>
        {
         show ? "" : card.isMark ? "" : <button 
        onClick={() => markAsRead(card.id)}
        className="px-3 py-1  bg-amber-400 rounded-xl text-black font-semibold">
